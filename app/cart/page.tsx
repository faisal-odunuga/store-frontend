...
export default function CartPage() {
  ...
  const checkoutMutation = useMutation({
    mutationFn: async () => {
      ...
      const paymentUrl = orderRes?.payment?.authorization_url;
      ...
      return paymentRes?.authorization_url;
    },
    onSuccess: (authUrl) => {
      if (authUrl) {
        clearCart();
      ...
      <div className='container mx-auto px-4 py-8 max-w-5xl'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
          ...
          <div className='lg:col-span-1'>
            <div className='rounded-lg border bg-card p-6 shadow-sm sticky top-24 space-y-4'>
              <div>
